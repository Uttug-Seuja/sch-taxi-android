...
class BottomTaxiReport(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        saveBtn.setBackgroundResource(R.drawable.custom_backgroundwhite_radius10)
        saveBtn.isEnabled = false
        saveBtn.setOnClickListener {
            when (spemType) {
                is PeriodType.All ->
                    callback.invoke("SPAM")
                is PeriodType.One ->
                    callback.invoke("SPAM")
                is PeriodType.Three ->
                    callback.invoke("SPAM")
        ...
        all.setOnClickListener {
            saveBtn.setBackgroundResource(R.drawable.custom_yellow_radius10)
